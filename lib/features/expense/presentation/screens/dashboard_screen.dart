          ...
          trend: cashFlow.lastMonthExpense > 0
              ? StatTrend(
                  percentage:
                      ...
                      100,
                  isPositive: cashFlow.expense <= cashFlow.lastMonthExpense,
                )
              : null,
          onTap: AppShellNavigation.openExpenses,
        );
        final savingsCard = AppStatCard(
          label: 'সঞ্চয়',
      ...
      children: [
        ...
        AppChip(
          ...
          onTap: () {
            Navigator.of(
              context,
            ).push(AppSlideRoute(builder: (_) => const BudgetPlannerScreen()));
          },
        ),
        AppChip(
          label: 'লক্ষ্য',
